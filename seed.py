...
EXEMPLOS = [
    dict(
        client_name="Joao Alves", client_company="Construtora Alfa",
        client_email="compras@alfa.com.br", client_phone="(41) 99999-0001",
    ...
    dict(
        client_name="Marina Souza", client_company="Metalurgica Beta",
        client_email="logistica@beta.com.br", client_phone=None,
    ...
    dict(
        ...
        client_email="gamma@obras.com.br", client_phone="(11) 98888-1234",
...
def run() -> None:
    ...
    try:
        ...
        # responde a primeira com uma proposta (com custo adicional)
        first = create_quote(
            db,
            dict(
                client_name="Cliente Demo", client_company="Demo Ltda",
                client_email="demo@exemplo.com", client_phone=None,
        ...
        total = Decimal("2900.00") + Decimal("50.00") + seguro
        add_proposal(
            db, first,
            dict(
                frete=Decimal("2900.00"), pedagio=Decimal("50.00"), seguro=seguro,
                total=total,
                custos_adicionais=Decimal("350.00"),
                custos_adicionais_desc="Guincho para carga em local sem doca",
                valor_final=total + Decimal("350.00"),
